...
list.files()  
# ============================================= #
write.table(GSE22490_limma_results, file = "GSE22490_annotated_results.tsv", quote = FALSE, sep = "\t", dec = ".", row.names=FALSE)
write.table(GSE22490_limma_results, file = "GSE22490_annotated_results.csv", quote = FALSE, sep = ";", dec = ".", row.names=FALSE)
# ============================================= # 
#                                               #
#                 Making Plots                  #
#                                               #
...
Volcanoplot_GSE22490 <- ggplot(GSE22490_limma_results,
       aes(x = logFC,
           y = -log10(P.Value),
           color = threshold)) +
  ...
  labs(
    title = "Volcano Plot of GSE22490: RPL vs Controls
    (Decidual Tissue)",
    x = "log2 fold change",
...
png("Volcano Plot of GSE22490.png",
    width = 631,
    height = 618)
Volcanoplot_GSE22490
dev.off()
