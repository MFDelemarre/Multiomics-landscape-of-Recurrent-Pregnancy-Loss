...
GSE113790_results <- DESeq2::results(GSE113790_DESeq_object, contrast=c("condition", "RPL", "Control"))
...
setwd(Folder_of_your_choice)
list.files()  
write.table(GSE113790_annotated_results, file = "GSE113790_annotated_results.tsv", quote = FALSE, sep = "\t", dec = ".", row.names=FALSE)
write.table(GSE113790_annotated_results, file = "GSE113790_annotated_results.csv", quote = FALSE, sep = ";", dec = ".", row.names=FALSE)
...
# ========================================================== #
# ggplot
Volcanoplot_GSE113790 <- ggplot(GSE113790_annotated_results,
  ...
  labs(
    title = "Volcano Plot of GSE113790: RPL vs Controls
    (Decidual Tissue)",
    x = "log2 fold change",
...
png("Volcano Plot of GSE113790.png",
    width = 631,
    height = 618)
Volcanoplot_GSE113790
dev.off()
