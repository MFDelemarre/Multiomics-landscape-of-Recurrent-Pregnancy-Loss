...
GSE183555_results <- DESeq2::results(GSE183555_DESeq_object, contrast=c("condition", "Control", "RPL"))
...
write.csv(GSE183555_annotated_results, file="GSE183555_annotated_results.csv", row.names=FALSE)
...
ggplot(GSE183555_annotated_results,
  ...
  labs(
    title = "Volcano Plot of GSE183555: Control vs RPL
    (Endometrial Tissue)",
    x = "log2 fold change",
