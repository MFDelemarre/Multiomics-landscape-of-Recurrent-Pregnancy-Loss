...
# ==========================================
GSE161969_results <- DESeq2::results(GSE161969_DESeq_object, contrast=c("condition", "Control", "RPL"))
...
# ========================================================== #
# 
write.csv(GSE161969_annotated_results, file="GSE161969_annotated_results.csv", row.names=FALSE)
...
ggplot(GSE161969_annotated_results,
...
str(GSE161969_vsd)
# Normalising & PCA
GSE161969_vsd <- vst(GSE161969_DESeq_object, blind=FALSE)
plotPCA(GSE161969_vsd, intgroup="condition") +  ggtitle("Principal Component Analysis GSE161969")
