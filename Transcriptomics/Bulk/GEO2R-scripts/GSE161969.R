...
path <- paste(urld, "acc=GSE161969", "file=GSE161969_raw_counts_GRCh38.p13_NCBI.tsv.gz", sep="&");
...
plotDispEsts(ds, main="GSE161969 Dispersion Estimates")

# create histogram plot of p-values
hist(r$padj, breaks=seq(0, 1, length = 21), col = "grey", border = "white", 
     xlab = "", ylab = "", main = "GSE161969 Frequencies of padj-values")
...
par(mar=c(7,4,2,1))
boxplot(dat[,ord], boxwex=0.6, notch=T, main="GSE161969", ylab="lg(norm.counts)", outline=F, las=2, col=gs[ord])
